module.exports = (function(){
	...
	function Restlet(){
		...
		this.getDataCenterByAccount = function(account, isProduction){
			var deferred = Q.defer();

			console.log('Loading Data Center by account...', account);
			var options = {
				url: `https://rest${isProduction ? '' : '.sandbox'}.netsuite.com/rest/datacenterurls?account=${account}`,
				json: true
			};
